...
| **21 CFR Part 11**                      | FDA training-data audit trail.                | Ed25519-signed audit envelopes with SHA-256 canonical receipts.                                                          | Validated electronic-signature programme under §11.10. Computer-system-validation lifecycle. |
