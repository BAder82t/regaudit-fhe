...
- Active backend: TenSEAL CKKS (`pip install regaudit-fhe[fhe]`).
  An OpenFHE backend is on the roadmap but not currently included
  (see `docs/roadmap/openfhe_backend.md`).
